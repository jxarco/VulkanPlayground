...
VkImageView VkCore::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void VkCore::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
    ...
    vkCmdBindIndexBuffer(commandBuffer, indexBuffer, 0, VK_INDEX_TYPE_UINT16); // 0 is the byte offset
...
void VkCore::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
